...
class TradesControllerTest < ActionController::TestCase
  ...
  test "should create trade" do
    assert_difference('Trade.count') do
      post :create, trade: { branch_id: @trade.branch_id, description: @trade.description, name: @trade.name }
    end
  ...
  test "should update trade" do
    put :update, id: @trade, trade: { branch_id: @trade.branch_id, description: @trade.description, name: @trade.name }
    assert_redirected_to trade_path(assigns(:trade))
  end
